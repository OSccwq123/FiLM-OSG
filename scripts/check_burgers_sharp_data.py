...
base_files = {
    'train': Path('data/BurgersOSG_train.mat'),
    'test': Path('data/BurgersOSG_test.mat'),
}
...
def stats(name, data):
    ...
    all_states = np.moveaxis(tr[:, :, 0, :], -1, 1)  # N,T,X
    ...
    # Energy/high-frequency proxy on initial condition.
