...
def main():
    ...
    print("=" * 80, flush=True)
    print("NS FNO evaluation", flush=True)
    ...
    # Save outputs.
    seedwise_csv = os.path.join(args.save_dir, "ns_fno_seedwise.csv")
    summary_csv = os.path.join(args.save_dir, "ns_fno_summary_by_model.csv")
    summary_json = os.path.join(args.save_dir, "ns_fno_summary_by_model.json")
